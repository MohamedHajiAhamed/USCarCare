...
{
    public class tbl_service1Controller : Controller
    {
        ...
        // GET: tbl_service1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: tbl_service1/Create
